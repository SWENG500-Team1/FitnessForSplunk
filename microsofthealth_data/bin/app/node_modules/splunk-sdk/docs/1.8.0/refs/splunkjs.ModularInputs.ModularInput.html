      ...
      <div class="row-fluid">
        ...
        <div class="span8">
            ...
            <section class="code">
              ...
              <h4 class="code-link">Source (<a target="_blank" href="https://github.com/splunk/splunk-sdk-javascript/blob/master/lib/modularinputs/modularinput.js#L288">lib/modularinputs/modularinput.js:288</a>)</h4>  
...
<p>The service object is created from the Splunkd URI and session key passed to the command invocation on the modular input stream. It is available as soon as the <code>ModularInput.streamEvents</code> function is called.</p>
            ...
            <section class="code">
              ...
              <h4 class="code-link">Source (<a target="_blank" href="https://github.com/splunk/splunk-sdk-javascript/blob/master/lib/modularinputs/modularinput.js#L229">lib/modularinputs/modularinput.js:229</a>)</h4>  
              <a class="btn btn-mini code-toggle"><i class="icon-plus"></i></a>
...
// Default to empty functions for life cycle events.</code></pre>
            ...
            <section class="code">
              ...
              <h4 class="code-link">Source (<a target="_blank" href="https://github.com/splunk/splunk-sdk-javascript/blob/master/lib/modularinputs/modularinput.js#L266">lib/modularinputs/modularinput.js:266</a>)</h4>  
              <a class="btn btn-mini code-toggle"><i class="icon-plus"></i></a>
            ...
            <section class="code">
              ...
              <h4 class="code-link">Source (<a target="_blank" href="https://github.com/splunk/splunk-sdk-javascript/blob/master/lib/modularinputs/modularinput.js#L277">lib/modularinputs/modularinput.js:277</a>)</h4>  
              <a class="btn btn-mini code-toggle"><i class="icon-plus"></i></a>
            ...
            <section class="code">
              ...
              <h4 class="code-link">Source (<a target="_blank" href="https://github.com/splunk/splunk-sdk-javascript/blob/master/lib/modularinputs/modularinput.js#L297">lib/modularinputs/modularinput.js:297</a>)</h4>  
              <a class="btn btn-mini code-toggle"><i class="icon-plus"></i></a>
